        ...
        <div class="d-flex" id="wrapper" data-aos="fade-right">
            ...
            <div class="border-right" id="sidebar-wrapper">
                <div class="sidebar-heading text-center">
                    <img src="/assets/images/logo-2.png" alt="" class="my-4" style="max-width: 150px" />
                </div>
                <div class="list-group list-group-flush">
                    <a href="{{ route('dashboard-muda-indonesia') }}"
                        class="list-group-item list-group-item-action {{ request()->is('admin/alchemist-muda-indonesia') ? 'active' : '' }}">Dashboard</a>
                    <a href="{{ route('header-muda-indonesia') }}"
                        class="list-group-item list-group-item-action {{ request()->is('admin/alchemist-muda-indonesia/header*') ? 'active' : '' }}">Header</a>
                    <a href="{{ route('about-muda-indonesia') }}"
                        class="list-group-item list-group-item-action {{ request()->is('admin/alchemist-muda-indonesia/about*') ? 'active' : '' }}">About</a>
                    <a href="{{ route('our-service-muda-indonesia') }}"
                        class="list-group-item list-group-item-action {{ request()->is('admin/alchemist-muda-indonesia/our-service*') ? 'active' : '' }}">Our
                        Service</a>
                    <a href="{{ route('experience-muda-indonesia') }}"
                        class="list-group-item list-group-item-action {{ request()->is('admin/alchemist-muda-indonesia/experience*') ? 'active' : '' }}">Experience</a>
                    <a href="{{ route('practicing-area-muda-indonesia') }}"
                        class="list-group-item list-group-item-action {{ request()->is('admin/alchemist-muda-indonesia/practicing-area*') ? 'active' : '' }}">Practicing
                        Area</a>
                    ...
                    <a href="{{ route('social-media-muda-indonesia') }}"
                        class="list-group-item list-group-item-action {{ request()->is('admin/alchemist-muda-indonesia/social-media*') ? 'active' : '' }}">Social
                        Media</a>
                    <a href="{{ route('logout') }}"
