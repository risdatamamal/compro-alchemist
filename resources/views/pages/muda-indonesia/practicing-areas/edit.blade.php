        ...
        <div class="container-fluid">
            <div class="dashboard-heading">
                ...
                <p class="dashboard-subtitle">
                    Edit "{{ $item->title }}" Practicing Area
                </p>
            </div>
            <div class="dashboard-content">
                <div class="row">
                    <div class="col-12">
                        ...
                        @endif
                        <form action="{{ route('update-list-practicing-area-muda-indonesia', $item->id) }}" method="post"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="title"
                                                    placeholder="Example: Criminal Law" value="{{ $item->title }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
