...
class PracticingAreaMudaIndonesiaController extends Controller
{
    public function index()
    {
        if (request()->ajax()) {
            $query = ListPracticingArea::query()->where('practicing_area_id', 2);
                        ...
                        <div class="btn-group">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="action' .  $item->id . '">
                                    <a class="dropdown-item" href="' . route('edit-practicing-area-muda-indonesia', $item->id) . '">
                                        Edit
                                    </a>
                                    <form action="' . route('delete-practicing-area-muda-indonesia', $item->id) . '" method="POST">
        ...
        $practicing_area = PracticingArea::where('id', 2)->first();

        return view('pages.muda-indonesia.practicing-areas.index', [
    ...
    public function updatePracticingArea(Request $request, $id)
    {
        ...
        return redirect()->route('practicing-area-muda-indonesia');
    }

    public function create()
    {
        return view('pages.muda-indonesia.practicing-areas.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.muda-indonesia.practicing-areas.edit', [
            'item' => $item
        ]);
    }
